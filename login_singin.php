                                ...
                                <form id="check_signin" method="POST" class="edit member">
                                    <div class="inner-w border-inner">
                                        <div class="warning" id="member_myselfError">
                                            แก้ไขข้อมูลส่วนตัวของ คุณ <?= $member['member_name'] ?>
                                        </div>
                                        ...
                                        <p>ชื่อผู้ใช้ :</p>
                                        <input type="text" name="input_user"  value="<?= $member['member_user'] ?>" maxlength="15"  class="tx_signin" placeholder="ชื่อผู้ใช้" disabled="">
                                        <p>รหัสผ่าน :</p>
                                        ...
                                        <input type="text" name="input_code" value="<?= $member['member_identification'] ?>" maxlength="13"  class="tx_signin" disabled="">
                                        <p>ที่อยู่ :</p>
