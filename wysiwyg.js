...
function generate_wysiwyg(textareaID) {
    ...
    var toolbar;
    toolbar = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1"><tr><td style="width: 6px;"><img src="' + imagesDir + 'seperator2.gif" alt="" hspace="3"></td>';
    ...
    var iframe = '<table cellpadding="0" cellspacing="0" border="0" class="taxtarea_comment"><tr><td valign="top">\n'
    ...
    //document.getElementById("wysiwyg" + n).style.width = 95 + "%";
...
function viewSource(n) {
    ...
    getDocument.body.style.fontSize = "10px";
    getDocument.body.style.fontFamily = "Tahoma";
